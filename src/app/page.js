...
export default function page() {
  return (
    <section className='w-full flex flex-wrap justify-center'>
      ...
      <div className=' w-full flex flex-wrap justify-center md:mt-6 mb-6 mt-3'>
        <div className='md:w-[60%] md:flex hidden justify-center items-center mt-8 mb-8 '>
        ...
        <div className='md:w-[40%] w-full flex justify-center mt-6 mb-6 '>
          <div className='xl:w-[70%] md:w-[90%] sm:w-[60%] flex flex-wrap justify-center w-[88%] rounded-3xl border-[3px] bg-[#10102e] border-[#7c7eda95]'>
            <h3 className='text-center w-full mt-8 text-lg font-bold text-white'>Register with</h3>
            <div className='flex w-full justify-center *:mx-3 *:mt-6 *:mb-5'>
            ...
            <SigninFrom />
            <div className='w-[80%] flex items-center mt-5'><div className=''><Switchdiv /></div><spna className='text-white m-2'>Remember me</spna></div>
            <p className='w-full text-center text-[#6c7f97] mt-5 mb-8'>Don't have an account ? <Link className='m-1 text-white font-bold' href='/Signup'>Sign up</Link></p>
          </div>
        </div>
      </div>
    </section>
